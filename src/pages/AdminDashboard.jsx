          ...
          <div className="table-container">
            ...
            <table>
              ...
              {bookings.length > 0 ? (
                bookings.map((booking) => (
                  <tr key={booking._id}>
                    <td>{booking?.userEmail}</td> {/* Updated email display */}
                    <td>{booking?.carName}</td>
                    <td>{booking?.date ? new Date(booking.date).toLocaleDateString() : "No Date"}</td>
                    <td>{booking?.phone}</td>
                    <td>{booking?.status}</td>
                  </tr>
                ))
                ...
                <tr>
                  <td colSpan="5">No bookings found</td> {/* Fixed colSpan for better UI */}
                </tr>
              )}
            </tbody>
